...
class UserRegistrationServiceTest {
    ...
    void registersNewUserWhenRequestIsValid() {
        ...
        UserRegistrationResponse response = service.register(new UserRegistrationRequest("alice", "alice@example.com"));
    ...
    void rejectsMissingRequiredFields() {
        ...
        assertThatThrownBy(() -> service.register(new UserRegistrationRequest("   ", "alice@example.com")))
    ...
    void rejectsDuplicateUsernameOrEmail() {
        ...
        assertThatThrownBy(() -> service.register(new UserRegistrationRequest("alice", "alice@example.com")))
                .isInstanceOf(IllegalArgumentException.class)
